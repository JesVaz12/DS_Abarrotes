...
--
-- Servidor: localhost
-- Tiempo de generación: 26-08-2025 a las 15:27:31
...
--
CREATE DATABASE IF NOT EXISTS `itemcontrol` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `itemcontrol`;
...
(9, 'admin', '$2y$10$/ndGjcWyFAKsc5MUkcvgwenYuBGC/jMt6yR2kiKdo2GGRdcR88TYi', 'gerente'),
(10, 'vendedor', '$2y$10$lXSZg/S.5R.MKtBBrDvyzulW14pnuo37J6nOslNAK5pYg5/zVvBXa', 'abarrotero'),
(14, 'brau', '$2y$10$bmC0y7zV06RiU.c.xtDZD.W214OsBWmGBnDjwQBzpWL6GEdfNutK2', 'abarrotero');
...
('root', '[{\"db\":\"itemcontrol\",\"table\":\"productos\"},{\"db\":\"itemcontrol\",\"table\":\"usuarios\"},{\"db\":\"itemcontrol\",\"table\":\"inventario_solicitudes\"},{\"db\":\"itemcontrol\",\"table\":\"categorias\"}]');
...
('root', 'itemcontrol', 'usuarios', '{\"sorted_col\":\"`usuarios`.`password` ASC\"}', '2025-06-02 04:53:08');
...
('root', '2025-08-26 13:25:41', '{\"lang\":\"es\",\"Console\\/Mode\":\"collapse\",\"ThemeDefault\":\"bootstrap\"}');
