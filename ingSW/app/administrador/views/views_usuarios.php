                    ...
                    <form method="post" class="row g-3 mb-4">
                        ...
                        <div class="col-md-3">
                            <input type="password" class="form-control" name="password" placeholder="Nueva contraseña (opcional)"
                                minlength="8" maxlength="72" title="Dejar vacío para no cambiar. Si se cambia, debe tener entre 8 y 72 caracteres.">
                        </div>
                    ...
                    <form method="post" class="row g-3 mb-4">
                        ...
                        <div class="col-md-3">
                            <input type="password" class="form-control" name="password" placeholder="Contraseña"
                                required minlength="8" maxlength="72" title="La contraseña debe tener entre 8 y 72 caracteres">
                        </div>
                        <div class="col-md-3">
                            <select class="form-select" name="rol" required>
